...
n = 5000  # Задание числового диапазона в генераторе рандомных чисел
random_src = [randint(1, n) for i in range(n)]  # Генерация списка большего объема для проверки времени и памяти.
print(random_src)
...
start = perf_counter()
result_1 = src_selection_1(random_src)
print(result_1)
...
start = perf_counter()
result_2 = [*src_selection_2(random_src)]
print(result_2)
...
start = perf_counter()
result_3 = src_selection_3(random_src)
...
start = perf_counter()
result_4 = src_selection_4(random_src)
